<script lang="ts">
	...
	// The 'Spring' class provides a smoothly animated value.
	// In Svelte 5, classes can be reactive!
	const count = new Spring(0);

	// '$derived' is a rune that automatically re-calculates when its dependencies change.
	// Here, 'offset' will update whenever 'count.current' changes.
